<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="SE_Project.ForgotPassword" %>
    ...
    <html>
        <body>
            ...
            margin-right:200px; width: 300px; height: 200px; bottom:400px; margin-left: 40px; text-align:center; margin-top: -20px">
                ...
                <formview>
                    <input type="text" id="UserName" name="UserName" class="input-line" placeholder="UserName" required>
                    <input type="text" id="NewPassword" name="NewPassword" class="input-line" placeholder="New Password" required>
                    <input type="text" id="RewritePassword" name="v" class="input-line" placeholder="Rewrite Password" required>
                    <button class="curved-button1" type="submit">Sign In</button>
