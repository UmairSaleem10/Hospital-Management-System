...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <body>
        ...
        <div class="background-theme">
            ...
            <p></p>
                HealthCare</b>
                <img src="images/HealthCare.png" style="float: left; margin-right: 10px; width: 480px; height: 320px; bottom: 200px; margin-left: 36px; text-align: center"></h1>
                    <p>
                        <h4>Comprehensive Healthcare for the whole family</h4>
                    </p>
                    <p class="right-align">
                        Health care Hospital is dedicated to delivering the highest standards of 
            ...
            <div>
                <h2>Our Features</h2>
                <asp:Button CssClass="curved-button" ID="btnPage1" runat="server" Text="Patient Record" PostBackUrl="~/Patient-Record.aspx" />
                <asp:Button CssClass="curved-button" ID="Button2" runat="server" Text="Appointment fixation" PostBackUrl="~/Appointment.aspx" />
                <asp:Button CssClass="curved-button" ID="Button3" runat="server" Text="Financial Accounts" PostBackUrl="~/Account.aspx" />
                <asp:Button CssClass="curved-button" ID="Button4" runat="server" Text="Our Employee" PostBackUrl="~/Employee.aspx" />
                <asp:Button CssClass="curved-button" ID="Button5" runat="server" Text="Hospital Managers" PostBackUrl="~/Manager.aspx" />
                <asp:Button CssClass="curved-button" ID="Button6" runat="server" Text="Worker Record" PostBackUrl="~/Worker.aspx" />
                <asp:Button CssClass="curved-button" ID="Button7" runat="server" Text="Medicine Details" PostBackUrl="~/Medicines.aspx" />
                <asp:Button CssClass="curved-button" ID="Button8" runat="server" Text="Patient Feedback" PostBackUrl="~/Feedback.aspx" />
                <asp:Button CssClass="curved-button" ID="Button9" runat="server" Text="Pharmacy Details" PostBackUrl="~/Pharmacy.aspx" />
            </div>
        </div>
    </body>
    </html>
